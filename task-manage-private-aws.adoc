...
---
= Acepte y configure una oferta privada de AWS Marketplace para la consola de NetApp
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Acepte una oferta privada de Marketplace para la consola de NetApp en la consola de AWS y configure las credenciales de AWS en la consola.
...
. Haga clic en *Configurar su cuenta*. Esto redirecciona a la consola de NetApp para configurar la suscripción.
+
[NOTE]
====
...
[IMPORTANT]
====
Es necesario completar la asignación de suscripción en la Consola para aplicar el precio con descuento.
...
. Localiza la suscripción creada anteriormente. Expande la fila para confirmar que esté asociada con tu cuenta de consola.
+
[NOTE]
====
...
[IMPORTANT]
====
Repita los pasos 1 a 4 para cada credencial de AWS en su cuenta de consola que desee asociar con la suscripción.

* Para las credenciales de otras organizaciones de la consola, utilice el menú desplegable *Organización* y repita los pasos.
* Para las credenciales de otros agentes, utilice el menú desplegable *Agente* y repita los pasos.

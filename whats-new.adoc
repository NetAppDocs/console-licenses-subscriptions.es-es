...
Para obtener más información, consulte lalink:https://docs.netapp.com/us-en/console/concept-billing-preferences.html["Documentación de preferencias de facturación"] .

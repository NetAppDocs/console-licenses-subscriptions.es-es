...
. Desde el menú de la consola de NetApp , seleccione *Gobernanza > Licencias y suscripciones*.
. Seleccione * Suscripciones Keystone *.
. Para la suscripción cuya capacidad desea ajustar, haga clic enimage:icon-action.png["Un icono que consta de tres puntos uno al lado del otro."] y seleccione *Ver detalle y editar*.

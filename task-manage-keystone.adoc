...
---
= Administrar suscripciones de Keystone
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
. Desde el menú de la NetApp Console , seleccione *Administración > Licenses and subscriptions*.
. Seleccione * Suscripciones Keystone *.
. Para la suscripción que quieres vincular, selecciona image:icon-action.png["Un icono que consta de tres puntos uno al lado del otro."] y selecciona *Enlazar*.
...
. Desde el menú de la NetApp Console , seleccione *Administración > Licenses and subscriptions*.
. Seleccione * Suscripciones Keystone *.
. Para la suscripción cuya capacidad quieras ajustar, selecciona image:icon-action.png["Un icono que consta de tres puntos uno al lado del otro."] y selecciona *Ver detalles y editar*.
. Ingrese la capacidad comprometida solicitada para una o más suscripciones.
. Desplázate hacia abajo, introduce cualquier detalle adicional para la solicitud y luego selecciona *Enviar*.
...
. Desde el menú de la NetApp Console , seleccione *Administración > Licenses and subscriptions*.
. Seleccione * Keystone*.
. Para la suscripción que quieres desvincular, selecciona image:icon-action.png["Un icono que consta de tres puntos uno al lado del otro."] y selecciona *Desvincular*.
